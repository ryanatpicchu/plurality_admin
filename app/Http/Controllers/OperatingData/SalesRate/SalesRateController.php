...
namespace App\Http\Controllers\OperatingData\SalesRate;
...
class SalesRateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.operating-data.sales-rate.index',['available_channels'=>$available_channels, 'available_regions'=>$available_regions, 'channel_groups'=>$channel_groups]);
    }
