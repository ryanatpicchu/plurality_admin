...
namespace App\Http\Controllers\OperatingData\SalesAmount;
...
class SalesAmountController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.operating-data.sales-amount.index',['available_channels'=>$available_channels, 'available_regions'=>$available_regions, 'channel_groups'=>$channel_groups]);
    }
