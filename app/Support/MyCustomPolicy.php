...
class MyCustomPolicy extends Basic
{
    public function configure()
    {
        ...
        if (str_contains($routeName, 'content-management') || str_contains($routeName, 'role')|| str_contains($routeName, 'user-management')) {
            ...
            ->addDirective('script-src-elem', ['self','unsafe-inline', 'cdn.amcharts.com', 'static.cloudflareinsights.com'])
            ->addDirective('style-src-elem', ['self','unsafe-inline','fonts.googleapis.com', 'cdn.datatables.net', 'cdn.ckeditor.com'])
            ...
            ->addDirective(Directive::BASE, Keyword::SELF)
            ->addDirective(Directive::CONNECT, ['self'])
            ->addDirective('script-src-elem', ['self', 'cdn.amcharts.com', 'static.cloudflareinsights.com'])
            ->addDirective('style-src-elem', ['self','fonts.googleapis.com', 'cdn.datatables.net', 'cdn.ckeditor.com'])
            ->addDirective(Directive::IMG, ['self', 'data:'])
            ->addDirective(Directive::FONT, ['self', 'fonts.googleapis.com', 'fonts.gstatic.com'])
            ->addDirective(Directive::OBJECT, Keyword::NONE)
            ->addDirective(Directive::FORM_ACTION, Keyword::SELF)
