	...
	<div class="modal-header">
		<h3 class="modal-title">{{__('ad-management.create-channel')}}</h3>
		<!--begin::Close-->
	...
	<!--end::Modal header-->
	<!--begin::Modal body-->
	<form id="store_channel_form" class="form" method="POST" action="{{ route('ad-management.store-channel')}}" >
	...
	<div class="modal-footer flex-center">
		...
		<!--end::Button-->
		<!--begin::Button-->
		<button type="button" id="store_channel_submit_button" class="btn btn-light-warning">
