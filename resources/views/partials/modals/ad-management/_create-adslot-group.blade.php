	...
	<div class="modal-header">
		<h3 class="modal-title">{{__('ad-management.create-adslot-group')}}</h3>
		<!--begin::Close-->
	...
	<!--end::Modal header-->
	<!--begin::Modal body-->
	<form id="store_adslot_group_form" class="form" method="POST" action="{{ route('ad-management.store-adslot-group')}}" >
				...
				<div class="row">
					...
					<div class="col-6">
						...
						<div class="fv-row mb-7">
							...
							<!--end::Label-->
							<!--begin::Select-->
							<select name="channel_group_id" class="form-select form-select-sm" data-control="select2"  data-hide-search="true" >
	...
	<div class="modal-footer flex-center">
		...
		<!--end::Button-->
		<!--begin::Button-->
		<button type="submit" id="store_adslot_group_submit_button" class="btn btn-light-warning">
