	...
	<div class="modal-header">
		<h3 class="modal-title">{{__('ad-management.edit-channel-group')}}</h3>
		<!--begin::Close-->
	...
	<!--end::Modal header-->
	<!--begin::Modal body-->
	<form id="update_channel_group_form" class="form" method="POST" action="{{ route('ad-management.update-channel-group')}}" >
				...
				<div class="row">
					<div class="col-4">
						...
						<div class="fv-row mb-7">
							...
							<!--end::Label-->
							<!--begin::Select-->
							<select class="form-select form-select-sm" data-control="select2"  data-hide-search="true" disabled>
					...
					<div class="col-2 d-flex align-items-center">
						...
						<div class="fv-row mb-7">
							...
							<select name="type" class="form-select form-select-sm"data-control="select2" data-hide-search="true" >
								...
								<option value="{{$type}}" @if($type==$record->type) selected @endif>{{__('general.channel-group-types_'.$type)}}</option>
								@endforeach
	...
	<div class="modal-footer flex-center">
		...
		<!--end::Button-->
		<!--begin::Button-->
		<button type="submit" id="update_channel_group_submit_button" class="btn btn-light-warning">
