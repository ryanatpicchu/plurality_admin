	...
	<!--end::Modal header-->
	<!--begin::Modal body-->
	<form id="confirm_delete_digitm_adslots" class="form" method="POST" action="{{route('ad-schedule.delete-digitm-adslots')}}" >
	...
	<div class="modal-footer flex-center">
		...
		<!--begin::Button-->
		<button type="button" id="delete_digitm_adslots_submit_button" class="btn btn-danger">
