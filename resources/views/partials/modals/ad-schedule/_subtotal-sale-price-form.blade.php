	...
	<!--end::Modal header-->
	<!--begin::Modal body-->
	<form id="confirm_subtoal_sale_price" class="form" method="POST" action="{{route('ad-schedule.adjust-discount-percentage')}}" >
					...
					<div class="d-flex flex-center">
						...
						<div class="d-flex flex-center">
							<span class="pe-2">
								...
								<input id="dynamic_subtotal_list_price" type="text" class="form-control form-control-solid form-control-sm" name="subtotal_list_price" value="{{ $subtotal_list_price }}" style="display: none;"/>
							</span>
							<span class="ps-0">
								<input id="dynamic_subtotal_sale_price" type="text" class="form-control form-control-solid form-control-sm" name="subtotal_sale_price" value="{{ $subtotal_list_price }}" />
							</span>
						</div>
						<div>
							<span class="fw-bold text-gray-600 ms-5">{{__('ad-schedule.total-discount-percentage')}}</span>
							<span id="dynamic_discount_percentage" class="fw-bolder fs-5 me-5 text-danger">0%</span>   
							<input id="new_discount_percentage" type="text" class="form-control form-control-solid form-control-sm" name="discount_percentage" value="" style="display:none;"/>
						</div>
					</div>
				</div>
	...
	<div class="modal-footer flex-center">
		...
		<!--end::Button-->
		<!--begin::Button-->
		<button type="button" id="adjust_discount_percentage_submit_button" class="btn btn-light-warning">
