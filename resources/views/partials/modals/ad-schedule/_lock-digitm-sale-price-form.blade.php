	...
	<div class="modal-header">
		<h3 class="modal-title">{{__('ad-schedule.please-confirm-lock-sale-price')}}</h3>
		<!--begin::Close-->
	...
	<!--end::Modal header-->
	<!--begin::Modal body-->
	<form class="form" method="POST" id="group_lock_digitm_sale_price_form">
			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-rounded table-striped border gy-7 gs-7">
						...
						<tbody>
							@if(isset($selected_adslot_groups['M']))
								@php
									$index_count = 1;
								@endphp
								@foreach($selected_adslot_groups['M'] as $adslot_group_key=>$adslot_group)
								<tr>
									<td>{{$index_count}}</td>
									@php
	...
	<div class="modal-footer flex-center">
		...
		<!--end::Button-->
		<!--begin::Button-->
		<button type="button" id="group_lock_digitm_sale_price_submit_button" class="btn btn-light-warning">
