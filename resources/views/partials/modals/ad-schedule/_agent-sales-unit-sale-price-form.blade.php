	...
	<!--end::Modal header-->
	<!--begin::Modal body-->
	<form id="confirm_agent_sales_unit_sale_price" class="form" method="POST" action="{{route('ad-schedule.set-agent-sales-unit-sale-price')}}" >
				...
				<div class="d-flex flex-column flex-md-row flex-md-stack justify-content-end">
					<div class="d-flex flex-center">
						<div class="d-flex flex-center">
							...
							<span class="ps-0">
								<input id="dynamic_agent_subtotal_sale_price" type="text" class="form-control form-control-solid form-control-sm" name="subtotal_sale_price" value="{{ $subtotal_sale_price }}" />
							</span>
						</div>
						<div class="d-flex flex-center">
							<span class="pe-2">
							...
							<span class="ps-0">
								<input id="dynamic_agent_sales_unit_list_price" type="text" class="form-control form-control-solid form-control-sm" name="sales_unit_list_price" value="{{ $sales_unit_list_price }}" />
							</span>
						</div>
						<div>
							<span class="fw-bold text-gray-600 ms-5">{{__('ad-schedule.promise-quantity')}}</span>
							<span id="dynamic_agent_promise_quantity" class="fw-bolder fs-5 me-5 text-danger">
								{{
									floor($subtotal_sale_price/$sales_unit_list_price)
								}}
							</span>   
							<input id="new_agent_promise_quantity" type="text" class="form-control form-control-solid form-control-sm" name="promise_quantity" value="" style="display:none;"/>
						</div>
					</div>
				</div>
	...
	<div class="modal-footer flex-center">
		...
		<!--end::Button-->
		<!--begin::Button-->
		<button type="button" id="set_agent_sales_unit_sale_price_submit_button" class="btn btn-light-warning">
