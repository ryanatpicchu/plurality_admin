	...
	<!--end::Modal header-->
	<!--begin::Modal body-->
	<form id="confirm_delete_remarketing_adslot" class="form" method="POST" action="{{route('ad-schedule.delete-remarketing-adslot')}}" >
	...
	<div class="modal-footer flex-center">
		...
		<!--begin::Button-->
		<button type="button" id="delete_remarketing_adslot_submit_button" class="btn btn-danger">
