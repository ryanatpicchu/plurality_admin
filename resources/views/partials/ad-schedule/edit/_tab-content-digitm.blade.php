                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <a combination_key="{{$adslot_group}}" href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-adslot" data-bs-toggle="modal" data-bs-target="#modal_delete_digitm_adslots">
