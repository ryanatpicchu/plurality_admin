...
// Class definition
var DeleteAgentAdSlots = function () {


    var modelContent,deleteAdSlotsForm,deleteAdSlotsModal;

    deleteAdSlotsForm = $('#delete_agent_adslot_form');
    deleteAdSlotsModal = $('#modal_delete_agent_adslot');
    modelContent = $('#modal_delete_agent_adslot div.modal-content');

    // Public functions
    return {
        // Initialization
        init: function () {
            $('.delete_agent_adslot').on('click',function(t){
                t.preventDefault();
                ...
                .then(function(response) {
                    ...
                    SubmitConfirmDeleteAgentAdslot.init();
                })
...
var SubmitConfirmDeleteAgentAdslot = function (){
    var modelContent,deleteAdslotsForm,deleteAdslotsModal;

    deleteAdslotsForm = $('#confirm_delete_agent_adslot');
    deleteAdslotsModal = $('#modal_delete_agent_adslot');
    modelContent = $('#modal_delete_agent_adslot div.modal-content');
    // Public functions
    return {
        ...
        init: function () {
            ...
            $('#delete_agent_adslot_submit_button').on('click',function(t){
                t.preventDefault();
                ...
                .then(function() {
                    ...
                    $('#delete_agent_adslot_submit_button').find('.indicator-label').show();
                    $('#delete_agent_adslot_submit_button').find('.indicator-progress').hide();
                    $('#delete_agent_adslot_submit_button').prop('disabled',false);
                });
