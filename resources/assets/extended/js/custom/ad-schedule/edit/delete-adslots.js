...
// Class definition
var DeleteAdSlots = function () {


    var modelContent,deleteAdSlotsForm,deleteAdSlotsModal;

    deleteAdSlotsForm = $('#delete_adslots_form');
    deleteAdSlotsModal = $('#modal_delete_adslots');
    modelContent = $('#modal_delete_adslots div.modal-content');

    // Public functions
    return {
        // Initialization
        init: function () {
            $('.delete_adslots_button').on('click',function(t){
                ...
                if(selected_adslot_groups.length <= 0){
                    Swal.fire({
                        ...
                        $('#modal_delete_adslots').modal("hide");
                    });
                }
                else{
                    ...
                    .then(function(response) {
                        ...
                        SubmitConfirmDeleteAdslots.init();
                    })
            ...
            $('.delete-adslot').on('click',function(t){
...
var SubmitConfirmDeleteAdslots = function (){
    var modelContent,deleteAdslotsForm,deleteAdslotsModal;

    deleteAdslotsForm = $('#confirm_delete_adslots');
    deleteAdslotsModal = $('#modal_delete_adslots');
    modelContent = $('#modal_delete_adslots div.modal-content');
    // Public functions
    return {
        ...
        init: function () {
            ...
            $('#delete_adslots_submit_button').on('click',function(t){
                t.preventDefault();
                ...
                .then(function() {
                    ...
                    $('#delete_adslots_submit_button').find('.indicator-label').show();
                    $('#delete_adslots_submit_button').find('.indicator-progress').hide();
                    $('#delete_adslots_submit_button').prop('disabled',false);
                });
