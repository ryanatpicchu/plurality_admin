...
// Class definition
var LockSalePrice = function () {


    var modelContent,lockSalePriceForm,lockSalePriceModal,unlockSalePriceForm,unlockSalePriceModal,unlockModelContent;

    lockSalePriceForm = $('#lock_sale_price_form');
    lockSalePriceModal = $('#modal_lock_sale_price');
    modelContent = $('#modal_lock_sale_price div.modal-content');

    unlockSalePriceForm = $('#unlock_sale_price_form');
    unlockSalePriceModal = $('#modal_unlock_sale_price');
    unlockModelContent = $('#modal_unlock_sale_price div.modal-content');

    // Public functions
    return {
        // Initialization
        init: function () {
            $('.lock-sale-price').on('change',function(t){
                ...
                if( $(this).is(':checked') ){
                    ...
                    if(selected_adslot_groups.length <= 0){
                        ...
                        Swal.fire({
                            ...
                            $('#modal_lock_sale_price').modal("hide");
                        });
                    }
                    else{
...
var SubmitLockSalePrice = function () {
    // Elements
    var form;
    var submitButton;
    ...
    var handleForm = function (e) {
        ...
        submitButton.on('click', function (e) {
            ...
            form.attr('action', '/ad-schedule/group-lock-sale-price');
    ...
    return {
        // Initialization
        init: function () {
            form = $('#group_lock_sale_price_form');
            submitButton = $('#group_lock_sale_price_submit_button');
...
var SubmitUnlockSalePrice = function () {
    // Elements
    var unlockForm;
    ...
    var handleForm = function (e) {
        ...
        unlockSubmitButton.on('click', function (e) {
            ...
            unlockForm.attr('action', '/ad-schedule/group-unlock-sale-price');
    ...
    return {
        ...
        init: function () {
            ...
            unlockForm = $('#group_unlock_sale_price_form');
            unlockSubmitButton = $('#group_unlock_sale_price_submit_button');
