...
return array(
    'v8.1.8' => array(
        ...
        'changelog' => array(
            ...
            'fix' => array(
                'Fix missing required body class <code>app-default</code>.',
                'Fix <code>&lt;?</code> in the blade HTML file.',
                'Fix sidebar animating behaviour.',
                'Fix <code>typed.js</code> version issue when build using webpack.'
            ),
        ),
    ),
